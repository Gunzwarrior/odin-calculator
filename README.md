This is my attempt at the last project of The Odin Project Foundation course where I have to make a working calculator using every skills learned with HTML, CSS and Javascript.
